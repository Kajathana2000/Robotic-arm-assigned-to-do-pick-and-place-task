...
% Define joint angle adjustment (customize as needed)
...
for i = 1:size(joint_angles, 1)
    plot_robot(IRB1100, joint_angles(i, :), position_names{i}, adjustment);
...
function plot_robot(robot, joint_angles, position_name, adjustment)
    ...
    title(['ABB IRB 1100-4/0.58 Robot Arm - ', position_name]);
end
